(function () {
  ...
  const html = `
      ...
      <nav class="sidebar-nav">
        ...
        ${navGroup('copytrading', 'Copy trading.png',   'Copy trading-selected.png',   'Copy Trading', 'Copy Trading', 'NEW',
            [
              ...
              { label: 'Copier',            href: 'copy-trading-portfolios.html' },
              { label: 'Signal Provider',   href: 'copy-trading-providers.html'  }
            ], copyTradingPages)}
    ...
    <div class="nav-flyout" id="flyout-wallet">
      ...
      <a class="flyout-item${page === 'wallet.html' ? ' active' : ''}" href="wallet.html">Discover</a>
    ...
    <div class="nav-flyout" id="flyout-copytrading">
      ...
      <a class="flyout-item${page === 'copy-trading.html' ? ' active' : ''}" href="copy-trading.html">Discover</a>
      <a class="flyout-item${page === 'copy-trading-portfolios.html' ? ' active' : ''}" href="copy-trading-portfolios.html">Copier</a>
      <a class="flyout-item${page === 'copy-trading-providers.html' ? ' active' : ''}" href="copy-trading-providers.html">Signal Provider</a>
    </div>
